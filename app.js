(function(){
    ...
    //EVENTO PARA LOS SIMBOLOS NUMEROS Y MAYUSCULAS
    ...
    function btnToggle(elementos){
        elementos.classList.toggle('false');
        elementos.childNodes[0].classList.toggle('fa-check'); 
        elementos.childNodes[0].classList.toggle('fa-times');
    }
    ...
    //EVENTO PARA COPIAR CON SOLO CLICKEAR
